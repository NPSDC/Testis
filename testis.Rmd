...
testis.single.cell <- read.csv('data/Run2_91509_gene_count_matrix_Testis_ProteinCoding.csv', 
             row.names = 1)
sl.rna <- read.table('data/GSE43717_RAW/GSM1069639_mmu_sl_m.FPKM.txt',
                     header = T)
sc.rna <- read.table('data/GSE43717_RAW/GSM1069641_mmu_sc_m.FPKM.txt',
                     header = T)
sg.rna <- read.table('data/GSE43717_RAW/GSM1069640_mmu_sg_m.FPKM.txt',
                     header = T)
sd.rna <- read.table('data/GSE43717_RAW/GSM1069642_mmu_sd_m.FPKM.txt',
                     header = T)
sz.rna <- read.table('data/GSE43717_RAW/GSM1069643_mmu_sz_m.FPKM.txt',
                     header = T)
